...
class TelemetryService {
    ...
    async initialize(options = {}) {
        ...
        try {
            const { serviceName = 'accountability-backend', serviceVersion = '1.0.0', environment = process.env.NODE_ENV || 'development', otlpEndpoint = process.env.OTLP_ENDPOINT || 'http://localhost:4318', enableAutoInstrumentation = true, } = options;
